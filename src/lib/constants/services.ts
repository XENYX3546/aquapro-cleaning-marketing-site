...
export const services: Service[] = [
  {
    ...
    seo: {
      ...
      keywords: ['carpet cleaning Essex', 'professional carpet cleaners', 'carpet stain removal', 'pet stain removal', 'carpet cleaning near me', 'deep carpet cleaning', 'commercial carpet cleaning', 'domestic carpet cleaning', 'hot water extraction', 'carpet cleaning service'],
    },
