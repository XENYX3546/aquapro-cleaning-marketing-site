          ...
          <div className="relative order-2 lg:order-1 mb-16 lg:mb-0">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-[300px] sm:h-[400px] lg:h-[600px]">
              <Image
                ...
                alt="Aquapro Exterior Cleaning Team"
                fill
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-10">
              ...
              <div className="flex items-start gap-4 group">
                <div className="w-12 h-12 rounded-2xl bg-brand-50 text-brand-600 flex items-center justify-center shrink-0 group-hover:bg-brand-600 group-hover:text-white transition-colors duration-300">
