...
export const metadata: Metadata = {
  ...
  description: `Learn about ${siteConfig.name} - over 10 years of experience delivering professional exterior cleaning services in Essex. Fully insured, 5-star rated, and trusted by 2000+ happy customers.`,
  keywords: [
    'about aquapro',
  ...
  openGraph: {
    ...
    description: `Dedicated to excellence in exterior cleaning. Over 10 years experience, 2000+ happy customers, and 5-star rated service across Essex.`,
