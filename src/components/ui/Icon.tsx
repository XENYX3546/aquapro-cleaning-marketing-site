...
export type IconName =
  ...
  | 'search' | 'link' | 'twitter' | 'linkedin' | 'github' | 'globe' | 'facebook' | 'instagram'
  | 'share' | 'clock' | 'mail' | 'map'
  // Cleaning service icons
  | 'sparkles' | 'sofa' | 'droplets' | 'home' | 'square' | 'spray' | 'shield-check' | 'star'
  // UI icons
  | 'plus' | 'minus';
...
const paths: Record<IconName, string> = {
  ...
  instagram: 'M17 2H7a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h10a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5zM12 16a4 4 0 1 1 0-8 4 4 0 0 1 0 8zM17.5 7.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2z',
  share: 'M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8M16 6l-4-4-4 4M12 2v13',
  clock: 'M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM12 6v6l4 2',
  mail: 'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zM22 6l-10 7L2 6',
  map: 'M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4zM8 2v16M16 6v16',
  // Cleaning service icons
  sparkles: 'M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM5 19l1 3 1-3 3-1-3-1-1-3-1 3-3 1 3 1zM19 10l.75 2.25L22 13l-2.25.75L19 16l-.75-2.25L16 13l2.25-.75L19 10z',
  sofa: 'M4 11V8a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v3M2 11v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2zM6 19v2M18 19v2M9 11V9M15 11V9',
  droplets: 'M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0L12 2.69zM7 13a5 5 0 0 0 5 5',
  home: 'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9zM9 22V12h6v10',
  square: 'M3 3h18v18H3zM8 8h8v8H8z',
  spray: 'M8 2h4v4H8zM10 6v3M6 12a4 4 0 0 1 8 0v9a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-9zM17 10l2-2M17 14h3M17 18l2 2M3 10l-2-2M3 14H0M3 18l-2 2',
